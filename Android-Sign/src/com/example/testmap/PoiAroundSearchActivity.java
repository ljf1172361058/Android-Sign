...
OnPoiSearchListener {
	...
	private int currentPage = 0;// 当前页面，从0�?��计数
...
//				startActivity(intent);
	...
	protected void doSearchQuery() {
		...
		query.setPageSize(20);// 设置每页�?��返回多少条poiitem
		...
		if (rcode == 1000) {
			if (result != null && result.getQuery() != null) {// 搜索poi的结�?
				if (result.getQuery().equals(query)) {// 是否是同�?��
					poiResult = result;
					poiItems = poiResult.getPois();// 取得第一页的poiitem数据，页数从数字0�?��
	...
	private class myPoiOverlay {
	     ...
	     * 返回第index的poi的信息�?
	     * @param index 第几个poi�?
	     * @return poi的信息�?poi对象详见搜索服务模块的基�?��心包（com.amap.api.services.core）中的类 <strong><a href="../../../../../../Search/com/amap/api/services/core/PoiItem.html" title="com.amap.api.services.core中的�?>PoiItem</a></strong>�?
	     * @since V2.1.0
	     */
